...
export default function ScreenFour (props: Props) {
  return <div className={'tutorial-screen screen-four'}>
    ...
    <p>As soon as you join a community, you can earn and spend {TENGE}hanks. There is no need to buy them first</p>
    ...
    <p>{TENGE}hanks are issued by mutual credit {DASH} each member acts as their own little bank, loaning money to others</p>
